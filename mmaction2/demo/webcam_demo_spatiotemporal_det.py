...
from mmaction.models1 import build_detector
from mmaction.utils1 import import_module_error_func
...
class MmdetHumanDetector(BaseHumanDetector):
    ...
    Args:
        ...
        person_classid (int): Choose class from detection results.
            Default: 0. Suitable for COCO pretrained models1.
    """
...
class StdetPredictor:
    """Wrapper for MMAction2 spatio-temporal action models1.
...
class ClipHelper:
    """Multithrading utils1 to manage the lifecycle of task."""
