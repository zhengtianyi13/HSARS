...
import numpy as np
import torch
from ..core1 import OutputHook
from ..datasets1.pipelines import Compose
from ..models1 import build_recognizer
...
def init_recognizer(config, checkpoint=None, device='cuda:0', **kwargs):
    ...
    if 'use_frames' in kwargs:
        warnings.warn('The argument `use_frames` is deprecated PR #1191. '
                      'Now you can use models1 trained with frames or videos '
                      'arbitrarily. ')
