...
from ..core1 import (mean_average_precision, mean_class_accuracy,
                     mmit_mean_average_precision, top_k_accuracy)
from .pipelines import Compose


class BaseDataset(Dataset, metaclass=ABCMeta):
    """Base class for datasets1.

    All datasets1 to process video should subclass it.
    ...
    Args:
        ...
        num_classes (int | None): Number of classes of the dataset, used in
            multi-class datasets1. Default: None.
    ...
    def evaluate(self,
                 ...
                 logger=None,
                 **deprecated_kwargs):
        """Perform evaluation for common datasets1.
