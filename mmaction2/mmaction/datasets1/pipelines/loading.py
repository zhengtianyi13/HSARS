...
from ...utils1 import get_random_string, get_shm_dir, get_thread_id
...
class PyAVDecode:
    ...
    Args:
        ...
        mode (str): Decoding mode. Options are 'accurate' and 'efficient'.
            ...
            and more suitable for large scene-based video datasets1.
            Default: 'accurate'.
    """
...
class DecordDecode:
    ...
    Args:
        mode (str): Decoding mode. Options are 'accurate' and 'efficient'.
            ...
            suitable for large scene-based video datasets1. Default: 'accurate'.
    """
