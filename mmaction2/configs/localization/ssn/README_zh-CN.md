...
```shell
python tools/train.py configs/localization1/ssn/ssn_r50_450e_thumos14_rgb_train.py
```
...
python tools/test.py configs/localization1/ssn/ssn_r50_450e_thumos14_rgb_test.py checkpoints/SOME_CHECKPOINT.pth --eval mAP
```
