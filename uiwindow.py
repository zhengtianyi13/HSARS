...
class Ui_window(object):
    def setupUi(self, window):
        window.setFixedSize(960, 700)  # 大小
        ...
        window.setCentralWidget(self.main_widget)  # 设置窗口主部件

        # 生成左侧按钮，左侧布局——————————————————————————————————————————————————————————
        self.left_close = QtWidgets.QPushButton("")  # 关闭按钮
        self.left_visit = QtWidgets.QPushButton("")  # 空白按钮
        self.left_mini = QtWidgets.QPushButton("")  # 最小化按钮
        self.left_mini2 = QtWidgets.QPushButton("")  # 最小化按钮
        self.left_mini3 = QtWidgets.QPushButton("")  # 最小化按钮
        ...
        self.cb.addItem(qtawesome.icon('ei.asl', color='white'),'TaNet')
        self.cb.addItem(qtawesome.icon('ei.asl', color='white'),'TSN')
        self.cb.addItem(qtawesome.icon('ei.asl', color='white'),'TimesFormer')

        self.left_button_1 = QtWidgets.QPushButton(qtawesome.icon('ei.adult', color='white'), "HRnet", window)
        ...
        self.left_button_4.setObjectName('left_button1')
        self.left_button_5 = QtWidgets.QPushButton(qtawesome.icon('fa.music', color='white'), "更多功能请联系我们")
        self.left_button_5.setObjectName('left_button')


        self.left_layout.addWidget(self.left_mini, 0, 0, 1, 1)
        # self.left_layout.addWidget(self.left_mini2, 0, 0, 1, 1)
        # self.left_layout.addWidget(self.left_mini3, 0, 4, 1, 1)
        self.left_mini.setStyleSheet(
            '''
            left:30px
            '''
        )
        self.left_mini.move(150,15)
        ...
        self.left_layout.addWidget(self.cb, 4, 0, 1, 3)
        ...
        self.labelshow = QtWidgets.QLabel('您当前使用的是：')
        self.labeltext.setObjectName('labelshow')  # 当前模块


        self.right_layout.addWidget(self.showlabel, 1, 0, 8, 7)
        self.right_layout.addWidget(self.labelshow, 0, 0, 1, 7)
        ...
        window.setAttribute(QtCore.Qt.WA_TranslucentBackground)  # 设置窗口背景透明
    ...
    # def retranslateUi(self, window):
        ...
        # window.setWindowTitle(_translate("window", "骨架识别系统"))
        # self.action.setText(_translate("window", "动作识别"))
        # self.pose.setText(_translate("window", "骨架识别"))
